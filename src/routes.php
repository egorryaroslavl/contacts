<?php
	...
	Route::group( [ 'middleware' => 'web', 'prefix' => 'admin' ], function (){
		...
		Route::post( '/contacts/store', 'egorryaroslavl\contacts\ContactsController@store' )->name( 'contacts-store' );

///home/egorr/Code/AdminPanel/Contacts/vendor/egorryaroslavl/admin/src/AdminController.php
